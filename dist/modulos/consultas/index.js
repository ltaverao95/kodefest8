...
(function (Index) {
    ...
    (function (Metodos) {
        Metodos.sendMessage = function (msg, update) {
            Data.Chats.guardarContexto(msg, core_1.Contextos.Consultas.Index.index).then(function () {
                var messageOptions = {
                    reply_markup: {
                        inline_keyboard: [
                            [
                                {
                                    text: Options.Saldos,
                                    callback_data: core_1.Contextos.Consultas.Saldos.saldos
                                }
                            ],
                            [
                                {
        ...
        Metodos.onConsultas = function (msg, update) {
            Data.Chats.getChat(msg).then(function (chatModel) {
