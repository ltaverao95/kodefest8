...
(function (index) {
    ...
    (function (Metodos) {
        ...
        Metodos.solicitarClave = function (msg) {
            Data.Chats.actualizarChat(msg.chat.id, core_1.Contextos.PaginaInicial.index, core_1.Comandos.PaginaInicial.Index.getClave).then(function () {
    ...
    (function (eventHandlers) {
        eventHandlers.listen = function () {
            initBot_1.bot.onText(/^\/start$/, function (msg, match) {
                Data.Chats.actualizarChat(msg.chat.id, core_1.Contextos.PaginaInicial.index, core_1.Comandos.PaginaInicial.Index.getUsuario).then(function () {
                ...
                Data.Chats.getChat(msg).then(function (chat) {
                    if (chat.contexto == core_1.Contextos.PaginaInicial.index
                        ...
                        if (utils_1.Validaciones.esNumeroRequeridoValido(msg.text)) {
                            Data.Clientes.actualizarDatosBasicos(msg, parseInt(msg.text)).then(function () {
